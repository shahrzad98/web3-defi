...
interface PrivateSaleVestingInterface extends ethers.utils.Interface {
  functions: {
    "INITIAL_UNLOCK()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "INITIAL_UNLOCK",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class PrivateSaleVesting extends Contract {
  ...
  interface: PrivateSaleVestingInterface;

  functions: {
    INITIAL_UNLOCK(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    INITIAL_UNLOCK(overrides?: CallOverrides): Promise<PopulatedTransaction>;
